      ...
      <HomeLayout>
        <main>
          <div className="relative isolate">
            <svg
              className="stroke-gray-200 absolute inset-x-0 top-0 -z-10 h-[64rem] w-full [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
              aria-hidden="true"
            >
              <defs>
                <pattern
              ...
              <svg x="50%" y={-1} className="fill-gray-50 overflow-visible">
                <path
              ...
              <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    ...
                    <p className="text-gray-600 mt-6 text-lg leading-8 sm:max-w-md lg:max-w-none">
                    ...
                    <div className="ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80 lg:order-last lg:pt-36 xl:order-none xl:pt-80">
                      <div className="relative">
                        <img
                          ...
                          alt=""
                          className="bg-gray-900/5 aspect-[2/3] w-full rounded-xl object-cover shadow-lg"
                        />
                        <div className="ring-gray-900/10 pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset" />
                      </div>
                    </div>
